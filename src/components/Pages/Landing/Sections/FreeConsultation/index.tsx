...
const FreeConsultation = () => {
  return (
    <div className="min-h-[183px] bg-[#0D3B66] text-white flex justify-between items-center max-lg:block
      ...
      <button className="bg-[#FF7F11] text-white text-[20px] max-md:text-[18px] flex justify-center items-center 
