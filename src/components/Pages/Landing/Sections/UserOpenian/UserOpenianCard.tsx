...
const UserOpenianCard = () => {
  return (
    <div className="border border-borderColor w-[427px] max-sm:w-[400px] min-h-[281px] rounded-[24px] px-6 py-6 space-y-5">
      ...
      <p className="text-dark dark:text-White text-[16px] text-justify">
        لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده
        از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و
        سطرآنچنان که لازم
      </p>
      <div className="flex gap-2 text-gray text-[14px]">
        <h4 className=" text-black dark:text-lightPrimary font-bold">اما واتسون</h4>-
