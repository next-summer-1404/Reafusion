...
const FilteringList: FC<IProps> = ({ ItemLength, locations, houses }) => {
  ...
  return (
    <div className="pt-10">
      ...
      <div className="w-[810px] max-xl:w-full flex justify-between text-primary dark:text-thidary text-[20px]">
        <h2 className="text-[24px] text-dark font-bold dark:text-white">فیلتر ها</h2>
