...
const CustomerInfoCard = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className='flex flex-col gap-8 justify-between p-4 rounded-3xl border border-borderColor bg-whiteColor dark:bg-dark box-border'>
