...
const DashboardMenu: FC<IProps> = ({ role, className }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: "مشخصات کاربری",
      icon: <UserRoundPen size={24} strokeWidth={1.5} />,
    },
    {
    ...
    ...(hasManagementAccess
      ? [
          {
            href: "/dashboard/placesManagement",
            label: "مدیریت املاک",
            icon: <Building size={24} strokeWidth={1.5} />,
          },
          {
            href: "/dashboard/financialManagement",
            label: "مدیریت مالی",
      ...
      : []),
    {
      href: "/dashboard/reservesManagment",
      label: "مدیریت رزروها",
    ...
    ...(isBuyerUser
      ? [
          ...
          {
            href: "/dashboard/favoriteManagement",
            label: "علاقه مندی ها",
            icon: <HeartPlus size={24} strokeWidth={1.5} />,
          },
        ]
      : []),
    {
    ...
    ...(idAdminUser
      ? [
          {
            href: "/dashboard/AllUsersManagement",
            label: "مدیریت کاربران",
            icon: <Users size={24} strokeWidth={1.5} />,
          },
          {
            href: "/dashboard/AllBookingManagement",
            label: "مدیریت کل رزروها",
            icon: <ChartBarDecreasing size={24} strokeWidth={1.5} />,
          },
          {
            href: "/dashboard/AllHousesManagement",
            label: "مدیریت کل خانه ها",
            icon: <Building2 size={24} strokeWidth={1.5} />,
          },
          {
            href: "/dashboard/CommentsManagement",
            label: "مدیریت نظرات",
            icon: <MessageCircleMore size={24} strokeWidth={1.5} />,
          },
          {
            href: "/dashboard/AllPaymentsManagments",
            label: "مدیریت کل پرداخت ها",
            icon: <CreditCard size={24} strokeWidth={1.5} />,
          },
          {
            href: "/dashboard/AllCategoriesManagement",
  ...
  return (
    <div
      className={`flex flex-col gap-8 py-8 bg-lightGray dark:bg-dark
    ...
    >
      ...
      <div className="flex flex-col px-8 max-xl:px-4 gap-8 overflow-y-auto">
              ...
              <li key={index}>
                ...
                >
                  <span
                    className={
                      pathname === item.href
                        ? "text-primary  dark:text-thidary"
                        : "text-dark dark:text-whiteColor"
                    }
                  >
                    {item.icon}
        ...
        {/* group */}
        <div className="flex flex-col gap-4">
          <span className="text-sm text-primary dark:text-thidary">
            مدیریت سایت ( ادمین ){" "}
          </span>
          {/* navigation */}
          <ul className="flex flex-col gap-6">
