...
const DashboardMenu: FC<IProps> = ({ role, className }) => {
    ...
    const menuItems = [
        ...
        { href: '/dashboard/AllBookingManagement', label: 'مدیریت کل رزروها', icon: <ChartBarDecreasing size={24} strokeWidth={1.5} /> },
        { href: '/dashboard/AllHousesManagement', label: 'مدیریت کل خانه ها', icon: <Building2 size={24} strokeWidth={1.5} /> },
