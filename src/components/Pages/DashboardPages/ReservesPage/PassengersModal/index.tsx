...
const rows = [
    createData(1, 'آقای فلانی', 'مرد', '09391234567'),
    createData(2, 'آقای فلانی', 'مرد', '09391234567'),
    createData(3, 'آقای فلانی', 'مرد', '09391234567'),
];

const PassengersModal: FC<IProps> = ({ open, onClose }) => {
    return (
        <Modal
            open={open}
            onClose={onClose}
                        ...
                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell align="right" sx={{ py: 3, px: 0, fontWeight: 'bold', fontSize: 16 }}>شماره تماس</TableCell>
                                ...
                                {rows.map((row) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right" sx={{ px: 0, py: 2 }}>{row.phone}</TableCell>
