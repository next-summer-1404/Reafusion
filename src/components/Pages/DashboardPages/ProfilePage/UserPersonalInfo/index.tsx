...
const UserPersonalInfo: FC<IProps> = ({ ProfileImage }) => {
  ...
  return (
    <>
      ...
      <form action={formAction} className="flex justify-between flex-wrap gap-4">
        <UserInput lable="نام" name="firstName" placeholder="نام خود رو وارد کنید" />
        <UserInput lable="نام خانوادگی" name="lastName" placeholder="نام خانوادگی خود را وارد کنید" />
        <UserInput lable="شماره تلفن" name="phoneNumber" placeholder="شماره تلفن خود را وارد کنید" />
        <UserInput lable="ایمیل" name="email" placeholder="ایمیل خود را وارد کنید" />
        <FillButton type="submit" ButtonText="اعمال تغییرات" className="p-3 px-4 max-sm:!w-full" />
      </form>
