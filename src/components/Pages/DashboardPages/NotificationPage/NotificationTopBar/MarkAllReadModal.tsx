...
const MarkAllReadModal: FC<IProps> = ({ open, handleClose }) => {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-[24px] text-dark font-bold text-center pt-4 px-2">
      ...
      <form onSubmit={handleSubmit} className="pt-6 flex justify-between">
        <button
          onClick={handleClose}
          className="text-gray border border-gray flex justify-center cursor-pointer items-center rounded-[16px] p-3 px-16"
        >
          انصراف
        </button>
