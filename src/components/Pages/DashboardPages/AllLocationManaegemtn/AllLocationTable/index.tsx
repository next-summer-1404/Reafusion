...
import { ILocationsDatas } from "@/core/types/IAllLocationsResponse";
...
const AllLocationTable: FC<IProps> = async ({ data, currentPage, totalPages }) => {
          ...
          {data.map((items) => (
            ...
            >
              ...
              <TableCell
                ...
                sx={{ px: 0, py: 2 }}
              >
                 <LocationActionMenu id={items.id} lat={items.lat} lng={items.lng} currentName={items.area_name} token={token}/>
              </TableCell>
            </TableRow>
          ))}
        </TableBody>
