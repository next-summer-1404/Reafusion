...
const VilaCard = () => {
  return (
    <div className="w-[312px] max-lg:w-[450px] max-md:w-full h-[126px] bg-[#F5F5F5] py-3 px-3  rounded-[24px] flex gap-5 mt-8">
      ...
      <div className="space-y-1.5 w-[60%] max-lg:w-[80%]">
        ...
        <h3 className="text-[16px] text-[#777777]">50 مورد</h3>
        <div className="flex justify-between pt-3 text-[#0D3B66] text-[16px] cursor-pointer">
            <h3>مشاهده</h3>
            <ArrowUpLeft size={26} />
        </div>
      </div>
