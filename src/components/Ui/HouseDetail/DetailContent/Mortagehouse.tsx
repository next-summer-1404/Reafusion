...
const Mortagehouse = () => {
  ...
  return (
    <div className='border border-borderColor dark:border-thidary dark:bg-dark rounded-[24px] w-[35%] max-lg:w-full h-[500] py-4 px-5 space-y-5'>
      ...
      <h3 className='text-center text-dark text-[20px] dark:text-white'>پویا اژکان</h3>
      <div className='flex justify-between'>
        <h3 className='text-primary text-[16px] dark:text-thidary flex gap-2'><Banknote /> قیمت رهن از  :</h3>
        <h3 className='text-dark text-[20px] dark:text-white font-bold'>20,000,000 تومان</h3>
      </div>
      <div className='flex justify-between'>
        <h3 className='text-primary text-[16px] dark:text-thidary flex gap-2'><BanknoteArrowUp /> قیمت اجاره از  :</h3>
        <h3 className='text-dark text-[20px] dark:text-white font-bold'>15,000,000 تومان</h3>
      </div>
      ...
      <div className='flex justify-between text-gray dark:text-borderColor text-[14px]'>
